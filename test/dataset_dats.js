...
//
  ...
  if(ATSCKptrisnull(tmp10)) {
    ATSINScaseof_fail("/home/artyom/projects/typesafe-dom/test/dataset.dats: 635(line=40, offs=7) -- 676(line=40, offs=48)");
  } // ifthen
  tmp11 = tmp10[0];
  ...
  if(ATSCKptrisnull(tmp12)) {
    ATSINScaseof_fail("/home/artyom/projects/typesafe-dom/test/dataset.dats: 683(line=41, offs=7) -- 724(line=41, offs=48)");
  } // ifthen
  tmp13 = tmp12[0];
  ...
  if(ATSCKptriscons(tmp14)) {
    ATSINScaseof_fail("/home/artyom/projects/typesafe-dom/test/dataset.dats: 731(line=42, offs=7) -- 773(line=42, offs=49)");
  } // ifthen
  strmap_set(tmp9, "notPresent", "1");
  tmp16 = strmap_get(tmp9, "notPresent");
  if(ATSCKptrisnull(tmp16)) {
    ATSINScaseof_fail("/home/artyom/projects/typesafe-dom/test/dataset.dats: 826(line=44, offs=7) -- 871(line=44, offs=52)");
  } // ifthen
  tmp17 = tmp16[0];
