...
** The starting compilation time is: 2019-1-26: 16h: 1m
**
*/
...
//
  ...
  tmp9 = get_dataset(tmp2);
  tmp10 = strmap_get(tmp9, "xFoo");
  if(ATSCKptrisnull(tmp10)) {
    ATSINScaseof_fail("/home/artyom/projects/typesafe-dom/test/dataset.dats: 648(line=40, offs=7) -- 689(line=40, offs=48)");
  } // ifthen
  tmp11 = tmp10[0];
  if(!ATSCKpat_bool(tmp11, "foo")) {
    ATSINScaseof_fail("/home/artyom/projects/typesafe-dom/test/dataset.dats: 648(line=40, offs=7) -- 689(line=40, offs=48)");
  } // ifnthen
  // ATSINSfreecon(tmp10);
  tmp12 = strmap_get(tmp9, "xBar");
  if(ATSCKptrisnull(tmp12)) {
    ATSINScaseof_fail("/home/artyom/projects/typesafe-dom/test/dataset.dats: 696(line=41, offs=7) -- 737(line=41, offs=48)");
  } // ifthen
  tmp13 = tmp12[0];
  if(!ATSCKpat_bool(tmp13, "bar")) {
    ATSINScaseof_fail("/home/artyom/projects/typesafe-dom/test/dataset.dats: 696(line=41, offs=7) -- 737(line=41, offs=48)");
  } // ifnthen
  // ATSINSfreecon(tmp12);
  tmp14 = strmap_get(tmp9, "notPresent");
  if(ATSCKptriscons(tmp14)) {
    ATSINScaseof_fail("/home/artyom/projects/typesafe-dom/test/dataset.dats: 744(line=42, offs=7) -- 786(line=42, offs=49)");
  } // ifthen
  strmap_set(tmp9, "notPresent", "1");
  tmp16 = strmap_get(tmp9, "notPresent");
  if(ATSCKptrisnull(tmp16)) {
    ATSINScaseof_fail("/home/artyom/projects/typesafe-dom/test/dataset.dats: 839(line=44, offs=7) -- 884(line=44, offs=52)");
  } // ifthen
  tmp17 = tmp16[0];
  if(!ATSCKpat_bool(tmp17, "1")) {
    ATSINScaseof_fail("/home/artyom/projects/typesafe-dom/test/dataset.dats: 839(line=44, offs=7) -- 884(line=44, offs=52)");
  } // ifnthen
  // ATSINSfreecon(tmp16);
  tmp1;
...
// dynloadflag_minit
var _057_home_057_artyom_057_projects_057_typesafe_055_dom_057_test_057_dataset_056_dats__dynloadflag = 0;

function
_057_home_057_artyom_057_projects_057_typesafe_055_dom_057_test_057_dataset_056_dats__dynload()
{
//
// knd = 0
  var tmplab, tmplab_js
//
  // ATSdynload()
  // ATSdynloadflag_sta(_057_home_057_artyom_057_projects_057_typesafe_055_dom_057_test_057_dataset_056_dats__dynloadflag(51))
  if(ATSCKiseqz(_057_home_057_artyom_057_projects_057_typesafe_055_dom_057_test_057_dataset_056_dats__dynloadflag)) {
    _057_home_057_artyom_057_projects_057_typesafe_055_dom_057_test_057_dataset_056_dats__dynloadflag = 1 ; // flag is set
    hello();
  } // end-of-if
  return/*_void*/;
} // end-of-function
