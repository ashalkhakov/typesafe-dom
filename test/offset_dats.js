...
//
  ...
  tmp11 = offsetLeft(tmp2);
  tmp10 = ats2jspre_eq_double_double(60.0, tmp11);
  atspre_assert_bool0(tmp10);
  tmp14 = offsetTop(tmp2);
  tmp13 = ats2jspre_eq_double_double(60.0, tmp14);
  atspre_assert_bool0(tmp13);
  tmp15 = offsetParent(tmp2);
  tmp18 = domnoderef_is_null(tmp15);
  tmp17 = ats2jspre_neg_bool1(tmp18);
  atspre_assert_bool1(tmp17);
  tmp21 = nodeType(tmp15);
  tmp20 = ats2jspre_eq_int1_int1(1, tmp21);
  atspre_assert_bool1(tmp20);
  tmp24 = nodeName(tmp15);
  tmp23 = ats2jspre_eq_string_string("BODY", tmp24);
...
// dynloadflag_minit
var _057_home_057_artyom_057_projects_057_typesafe_055_dom_057_test_057_offset_056_dats__dynloadflag = 0;

function
_057_home_057_artyom_057_projects_057_typesafe_055_dom_057_test_057_offset_056_dats__dynload()
{
//
// knd = 0
  var tmplab, tmplab_js
//
  // ATSdynload()
  // ATSdynloadflag_sta(_057_home_057_artyom_057_projects_057_typesafe_055_dom_057_test_057_offset_056_dats__dynloadflag(60))
  if(ATSCKiseqz(_057_home_057_artyom_057_projects_057_typesafe_055_dom_057_test_057_offset_056_dats__dynloadflag)) {
    _057_home_057_artyom_057_projects_057_typesafe_055_dom_057_test_057_offset_056_dats__dynloadflag = 1 ; // flag is set
    hello();
  } // end-of-if
  return/*_void*/;
} // end-of-function
