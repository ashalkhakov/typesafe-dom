...
** The starting compilation time is: 2019-1-25: 22h: 0m
**
*/
...
//
  ...
  tmp9 = firstChild(tmp2);
  tmp11 = domnoderef_is_null(tmp9);
  atspre_assert_bool1(tmp11);
  tmp12 = getElementById(tmp1, "p2");
  tmp15 = domnoderef_is_null(tmp12);
  tmp14 = ats2jspre_neg_bool1(tmp15);
  atspre_assert_bool1(tmp14);
  tmp18 = nodeType(tmp12);
  tmp17 = ats2jspre_eq_int1_int1(1, tmp18);
  atspre_assert_bool1(tmp17);
  tmp19 = firstChild(tmp12);
  tmp22 = domnoderef_is_null(tmp19);
  tmp21 = ats2jspre_neg_bool1(tmp22);
  atspre_assert_bool1(tmp21);
  tmp25 = nodeType(tmp19);
  tmp24 = ats2jspre_eq_int1_int1(3, tmp25);
  atspre_assert_bool1(tmp24);
  tmp28 = cdata_length(tmp19);
  tmp27 = ats2jspre_eq_int1_int1(1, tmp28);
  atspre_assert_bool1(tmp27);
  tmp31 = cdata_data(tmp19);
  tmp30 = ats2jspre_eq_string_string(" ", tmp31);
  atspre_assert_bool0(tmp30);
  tmp32 = createTextNode(tmp1, "Hello");
  tmp33 = getElementById(tmp1, "p3");
  tmp36 = domnoderef_is_null(tmp33);
  tmp35 = ats2jspre_neg_bool1(tmp36);
  atspre_assert_bool1(tmp35);
  tmp39 = nodeType(tmp33);
  tmp38 = ats2jspre_eq_int1_int1(1, tmp39);
  atspre_assert_bool1(tmp38);
  tmp40 = appendChild(tmp33, tmp32);
  cdata_appendData(tmp40, " ");
  cdata_appendData(tmp40, "user!");
  tmp45 = cdata_length(tmp40);
  tmp44 = ats2jspre_eq_int1_int1(11, tmp45);
  atspre_assert_bool1(tmp44);
  cdata_insertData(tmp40, 5, ",");
  tmp49 = cdata_data(tmp40);
  tmp48 = ats2jspre_eq_string_string("Hello, user!", tmp49);
  atspre_assert_bool0(tmp48);
  cdata_deleteData(tmp40, 11, 1);
  cdata_replaceData(tmp40, 0, 6, "Hi");
  tmp54 = cdata_data(tmp40);
  tmp53 = ats2jspre_eq_string_string("Hi user", tmp54);
  atspre_assert_bool0(tmp53);
  tmp1;
  return/*_void*/;
} // end-of-function

// dynloadflag_minit
var _057_home_057_artyom_057_projects_057_typesafe_055_dom_057_test_057_text_056_dats__dynloadflag = 0;

function
_057_home_057_artyom_057_projects_057_typesafe_055_dom_057_test_057_text_056_dats__dynload()
{
//
// knd = 0
  var tmplab, tmplab_js
//
  // ATSdynload()
  // ATSdynloadflag_sta(_057_home_057_artyom_057_projects_057_typesafe_055_dom_057_test_057_text_056_dats__dynloadflag(93))
  if(ATSCKiseqz(_057_home_057_artyom_057_projects_057_typesafe_055_dom_057_test_057_text_056_dats__dynloadflag)) {
    _057_home_057_artyom_057_projects_057_typesafe_055_dom_057_test_057_text_056_dats__dynloadflag = 1 ; // flag is set
    hello();
  } // end-of-if
  return/*_void*/;
} // end-of-function
